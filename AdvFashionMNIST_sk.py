...
class NetCIFAR10(Nets.Net):
    ...
    def train(self, genTrain, genTest, pathLoad=None, pathSave=None):
        with self._graph.as_default(): 
            ...
            self._lrDecay1 = tf.assign(self._lr, self._lr * 0.2)
            ...
            self._optimizerP = tf.train.AdamOptimizer(self._lr2, epsilon=1e-8).minimize(self._lossPredictor, var_list=self._varsP)
